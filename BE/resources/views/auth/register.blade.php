            ...
            <div class="flex-1 text-center lg:text-left">
                <div class="mb-12 -mt-8">
                    <h1 class="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
                        Join the<br />
                        <span class="text-orange-600">Roasty</span> Community
                    </h1>
                    <p class="text-lg text-gray-600">
                        Start your coffee journey with us and get access to premium beans, exclusive classes, and more
                    </p>
                </div>
                    ...
                    <form id="registerForm" class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <input type="checkbox" id="terms" required
                                class="w-4 h-4 mt-1 text-orange-600 border-gray-300 rounded focus:ring-orange-500">
                            <label for="terms" class="ml-2 text-sm text-gray-600">
                                Saya setuju dengan
                                <a href="#" class="text-orange-600 hover:text-orange-700 font-medium">Syarat &
                                    Ketentuan</a>
                                dan
                                <a href="#" class="text-orange-600 hover:text-orange-700 font-medium">Kebijakan
                                    Privasi</a>
                            </label>
                        </div>
    ...
    <script>
        ...
        registerForm.addEventListener('submit', async function (e) {
            ...
            if (!name || !email || !phone || !password || !confirmPassword || !terms) {
                errorMessage.textContent = 'Mohon lengkapi semua field!';
