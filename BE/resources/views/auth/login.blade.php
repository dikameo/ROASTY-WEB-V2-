    ...
    <script>
        ...
        async function login(e) {
            ...
            try {
                ...
                setTimeout(() => {
                    console.log('🔄 Redirect berdasarkan role:', user.role);

                    if (user.role === 'admin') {
                        console.log('👨‍💼 Admin login detected - redirecting to admin_dashboard.html');
                        window.location.href = "{{ route('admin.dashboard') }}";
                    } else {
                        console.log('👤 Regular user login detected - redirecting to Halaman.beranda.html');
