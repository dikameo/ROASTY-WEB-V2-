    ...
    if (cart.length === 0) {
        ...
        container.innerHTML = `
            <div class="flex flex-col items-center justify-center min-h-screen">
                ...
                <button onclick="window.location.href='{{ route('home') }}'" class="bg-primary hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold">
                    Lanjutkan Belanja
                </button>
            </div>
        `;
        ...
        if (cartProducts.length === 0) {
            ...
            container.innerHTML = `
                <div class="flex flex-col items-center justify-center min-h-screen">
                    ...
                    <button onclick="localStorage.removeItem('cart'); window.location.href='{{ route('home') }}'" class="bg-primary hover:bg-orange-600 text-white px-6 py-3 rounded-lg font-semibold">
            ...
            itemDiv.innerHTML = `
                ...
                <div class="flex flex-1 gap-4 flex-col sm:flex-row">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 shrink-0 rounded-lg overflow-hidden border border-[#f4ece7] dark:border-white/5 bg-gray-100">
                        <img alt="${product.name}" class="w-full h-full object-cover" src="${imageUrl}" onerror="this.onerror=null;this.src='${fallbackImage}'"/>
                    </div>
